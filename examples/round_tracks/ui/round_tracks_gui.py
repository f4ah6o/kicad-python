...
class RoundTracksDialog(wx.Dialog):
    def __init__(self, parent):
        wx.Dialog.__init__(
            ...
            parent,
            id=wx.ID_ANY,
            title="Round Tracks IPC API Demo",
        ...
        self.netclasslist = wx.dataview.DataViewListCtrl(
            self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, 0
        )
        self.netclasslist.SetMinSize(wx.Size(450, 100))

        self.net_class = self.netclasslist.AppendTextColumn(
            "Net Class",
        ...
        self.do_rounding = self.netclasslist.AppendToggleColumn(
            "Rounding",
        ...
        self.scaling = self.netclasslist.AppendTextColumn(
            "Radius (mm)",
        ...
        self.passes = self.netclasslist.AppendTextColumn(
            "Passes #",
            wx.dataview.DATAVIEW_CELL_EDITABLE,
            80,
            wx.ALIGN_LEFT,
        ...
        self.do_create = wx.CheckBox(
            self, wx.ID_ANY, "create a new file", wx.DefaultPosition, wx.DefaultSize, 0
        )
        grid_horiz.Add(self.do_create, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_LEFT, 5)

        self.use_native = wx.CheckBox(
            self, wx.ID_ANY, "use native fillets", wx.DefaultPosition, wx.DefaultSize, 0
        )
        self.use_native.SetValue(True)
        grid_horiz.Add(self.use_native, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_LEFT, 5)

        self.avoid_junctions = wx.CheckBox(
            self, wx.ID_ANY, "ignore junctions", wx.DefaultPosition, wx.DefaultSize, 0
        )
        grid_horiz.Add(
            self.avoid_junctions, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_LEFT, 5
        )

        self.apply = wx.Button(self, wx.ID_ANY, "Run", wx.DefaultPosition, wx.Size(120, -1), 0)
        ...
        self.netclasslist.Bind(
            wx.dataview.EVT_DATAVIEW_ITEM_EDITING_DONE, self.on_item_editing, id=wx.ID_ANY
        )
